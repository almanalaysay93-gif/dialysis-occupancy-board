...
|---|---|---|---|
| `supervisor` | `Supervisor1234` | SKTI Supervisor | All five boards (SKTI Main, RDU Annex, RDU Main, SKTI ICU, SKTI Service Ward), room management, and the End of Day report for every board |
